...
- **Over-engineering** — extra interfaces, handler chains, catalogs, normalized-time authoring when frames + direct hooks suffice (§3b)
...
**Presentation timing:** [docs/code/animation-presentation-schedule.md](docs/code/animation-presentation-schedule.md) — frame-based schedule SO + scheduler + hooks (no clip events).
